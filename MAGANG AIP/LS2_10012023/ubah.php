...
$query = "SELECT * FROM table_usercreation WHERE id = '$id'";

// sambungkan koneksi sama query
$result = mysqli_query($coinn, $query);

// Merapihkan data kedalam ray
...
<body>
    <div class="continer-ld col-md-6 mx-auto shadow-lg p-3 mb-5 bg-body-tertiary rounded" style="height: 600px; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
        ...
        <div class="content-newuser" style="margin-top: 50px;" >
            <h1 style="text-align: center; font-size: 60px;">Edit User Creation</h1>
            ...
            <div class="container">
                <div class="row row-cols-2">
                  <div class="col">
                    ...
                    <input type="text" value="<?= $row['nama_dpn']?>" class="form-control" id="nama-dpn" style="border-radius: 15px;">
            ...
            <!-- ini buat input nama belakang - usercreative-->
                  <div class="col">
                    ...
                    <input type="text" class="form-control" id="nama_blkng" style="border-radius: 15px;">
